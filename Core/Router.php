...
use LateMotivApp\Controllers\MainController;


// routeur basé sur celui de Benoît GAMBIER du site nouvelle-techno.fr
...
class Router
{
    public function start()
    {
        ...
        if(isset($params[0])&& !empty($params[0])){
            ...
            $controller = '\\LateMotivApp\\Controllers\\'.ucfirst(array_shift($params)).'Controller';
