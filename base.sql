...
--
DROP DATABASE IF EXISTS ` yohannhoury_late_motiv_app`;
CREATE DATABASE IF NOT EXISTS ` yohannhoury_late_motiv_app` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE ` yohannhoury_late_motiv_app`;
